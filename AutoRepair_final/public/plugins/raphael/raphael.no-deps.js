...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! eve */ "eve")], __WEBPACK_AMD_DEFINE_RESULT__ = (function(eve) {
     ...
     * Parses colour string as RGB object
     ...
     #     <li>#••• — shortened HTML colour: (“<code> rgb(64,63,64)</code>”, “<code>#fc0</code>”, etc)</li>
     #     <li>#•••••• — full length HTML colour: (“<code> rgb(64,63,64)000</code>”, “<code>#bd2300</code>”)</li>
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! ./raphael.core */ "./dev/raphael.core.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function(R) {
     ...
     * or
     ...
     o y (number)
     > Gradients
     * Linear gradient format: “`‹angle›-‹colour›[-‹colour›[:‹offset›]]*-‹colour›`”, example: “`90-#fff- rgb(64,63,64)`” – 90°
     * gradient from white to black or “`0-#fff-#f00:20- rgb(64,63,64)`” – 0° gradient from white via red (at 20%) to black.
     *
     * radial gradient: “`r[(‹fx›, ‹fy›)]‹colour›[-‹colour›[:‹offset›]]*-‹colour›`”, example: “`r#fff- rgb(64,63,64)`” –
     * gradient from white to black or “`r(0.25, 0.75)#fff- rgb(64,63,64)`” – gradient from white to black with focus point
    ...
    R._engine.circle = function (svg, x, y, r) {
        ...
        res.attrs = {cx: x, cy: y, r: r, fill: "none", stroke: " rgb(64,63,64)"};
        res.type = "circle";
        $(el, res.attrs);
        return res;
    };
    R._engine.rect = function (svg, x, y, w, h, r) {
        ...
        svg.canvas && svg.canvas.appendChild(el);
        var res = new Element(el, svg);
        res.attrs = {x: x, y: y, width: w, height: h, rx: r || 0, ry: r || 0, fill: "none", stroke: " rgb(64,63,64)"};
        res.type = "rect";
        $(el, res.attrs);
        return res;
    };
    R._engine.ellipse = function (svg, x, y, rx, ry) {
        ...
        svg.canvas && svg.canvas.appendChild(el);
        var res = new Element(el, svg);
        res.attrs = {cx: x, cy: y, rx: rx, ry: ry, fill: "none", stroke: " rgb(64,63,64)"};
        res.type = "ellipse";
        $(el, res.attrs);
        return res;
    };
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! ./raphael.core */ "./dev/raphael.core.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function(R) {
    ...
    R._engine.path = function (pathString, vml) {
        ...
        var p = new Element(el, vml),
            attr = {fill: "none", stroke: " rgb(64,63,64)"};
